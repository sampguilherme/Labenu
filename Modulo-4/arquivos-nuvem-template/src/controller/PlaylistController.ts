...
import { CreatePlaylistInputDTO, DeletePlaylistInputDTO, EditPlaylistInputDTO, GetPlaylistsInputDTO, LikeOrDislikePlaylistInputDTO } from "../dtos/playlistDTO"
    ...
    public createPlaylist = async (req: Request, res: Response) => {
        try {
          const input: CreatePlaylistInputDTO = {
            ...
            const response = await this.playlistBusiness.createPlaylist(input)
